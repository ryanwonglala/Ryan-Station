  ...
  const translations = {
    en: {
      ...
      hero: {
        ...
        status: 'Open to robotics & automation roles',
        clockLabel: 'Singapore time, GMT+8',
        sensorHint: 'move — you are the sensor',
      },
      led: {
        now: 'NOW',
        next: 'NEXT',
      ...
      work: {
        label: 'Selected Work',
        title: 'Four projects, four kinds of hard.',
        intro:
          'Simulation to real hardware, mechanism design to system integration. Every claim here survived a demo, a test rig, or a live competition.',
        viewCase: 'Open case file',
        closeCase: 'Close case file',
      ...
      about: {
        ...
        offDuty:
          'Pixel art and old games, anime and manga, the occasional philosophy book, and a stubborn belief that engineering is an act of care. This station — and its hamster — is what happens when those things are allowed near a website.',
        mascotAlt: 'Station mascot illustration',
    ...
    zh: {
      ...
      hero: {
        ...
        scroll: '向下',
        location: '新加坡 · GMT+8',
        status: '开放机器人与自动化岗位机会',
        clockLabel: '新加坡时间，GMT+8',
        sensorHint: '动一动——你就是传感器',
      },
      led: {
        now: '当前',
        next: '下一站',
      ...
      work: {
        ...
        title: '四个项目，四种难法。',
        intro:
          '从仿真到实机，从机构设计到系统集成。这里的每一句话，都经过演示、试验台或现场比赛的检验。',
        viewCase: '打开案例档案',
        closeCase: '关闭案例档案',
        prev: '上一个项目',
        next: '下一个项目',
      ...
      about: {
        ...
        offDuty:
          '像素画与老游戏、动画与漫画、偶尔翻翻哲学书，以及一个固执的信念：工程是一种在乎的方式。这座车站——和那只仓鼠——就是这些东西靠近一个网站之后的样子。',
        mascotAlt: '车站吉祥物插画',
        blueprintAria: '自动绘制的六自由度机械臂蓝图',
      },
      journey: {
        label: '旅程',
        title: '发车记录。',
